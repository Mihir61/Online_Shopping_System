...
<fieldset style="background:#22423b;width:50%">
<br><br>
	<?php
...
<table width="366" border="0" align="center">
  ...
  <tr>
    ...
    <td><input name="m3" type="text" id="m3" onChange="return lnam()" readonly="readonly" value="BDT<?php echo $mat['price'];?>">  </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><label>
      <select name="sel2" id="sel2">
        <option value="SBBJ">SIBL</option>
        <option value="SBI" selected>DBBL</option>
        <option value="ICICI">City Bank</option>
        <option value="HDFC">Brac Bank</option>
        <option value="PNB">Prime Bank limited</option>
        <option value="Axis Bank">Southeast Bank Limited</option>
      </select>
    </label></td>
  </tr>
  <tr>
